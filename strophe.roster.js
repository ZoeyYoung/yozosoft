...
Strophe.addConnectionPlugin('roster', {
  ...
  update: function(jid, name, groups, call_back) {
    ...
    var iq = $iq({type: 'set'}).c('query', {xmlns: Strophe.NS.ROSTER}).c('item', {jid: item.jid, name: newName});
  ...
  remove: function(jid, call_back) {
    ...
    var iq = $iq({type: 'set'}).c('query', {xmlns: Strophe.NS.ROSTER}).c('item', {jid: item.jid, subscription: "remove"});
    this._connection.sendIQ(iq, call_back, call_back);
  },
